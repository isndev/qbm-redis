...
TEST(ServerAPITest, ValueExtractorUniquePtr) {
    auto val = std::make_unique<qb::redis::parser::Value>(qb::redis::parser::BulkString{"hello world"});
...
TEST(ServerAPITest, ExtractStringArrayHelper) {
    ...
    arr.elements.push_back(std::make_unique<qb::redis::parser::Value>(qb::redis::parser::BulkString{"first"}));
    arr.elements.push_back(std::make_unique<qb::redis::parser::Value>(qb::redis::parser::BulkString{"second"}));
...
TEST(ServerAPITest, ValueExtractorArray) {
    qb::redis::parser::Array arr;
    arr.elements.push_back(std::make_unique<qb::redis::parser::Value>(qb::redis::parser::Integer{1}));
    arr.elements.push_back(std::make_unique<qb::redis::parser::Value>(qb::redis::parser::Integer{2}));
    arr.elements.push_back(std::make_unique<qb::redis::parser::Value>(qb::redis::parser::Integer{3}));
...
TEST(ServerAPITest, ValueExtractorMap) {
    ...
    map.entries.push_back(std::make_pair(std::make_unique<qb::redis::parser::Value>(qb::redis::parser::BulkString{"key1"}),
