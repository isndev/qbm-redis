...
public:
    ...
    subscribe(const std::string &channel) {
        return static_cast<Derived &>(*this)
            .template command<reply::subscription>("SUBSCRIBE", channel)
            .result;
    }
    ...
    psubscribe(const std::string &channel) {
        return static_cast<Derived &>(*this)
            .template command<reply::subscription>("PSUBSCRIBE", channel)
            .result;
    }
    template <typename Func>
    std::enable_if_t<std::is_invocable_v<Func, Reply<reply::subscription> &&>, Derived &>
    ...
    unsubscribe(const std::string &channel) {
        return static_cast<Derived &>(*this)
            .template command<reply::subscription>("UNSUBSCRIBE", channel)
            .result;
    }
    template <typename Func>
    std::enable_if_t<std::is_invocable_v<Func, Reply<reply::subscription> &&>, Derived &>
    ...
    punsubscribe(const std::string &channel) {
        return static_cast<Derived &>(*this)
            .template command<reply::subscription>("PUNSUBSCRIBE", channel)
            .result;
    }
    template <typename Func>
    std::enable_if_t<std::is_invocable_v<Func, Reply<reply::subscription> &&>, Derived &>
